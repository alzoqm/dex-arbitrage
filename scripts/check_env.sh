...
base_verify=(BASE_PUBLIC_RPC_URL BASE_AAVE_POOL BASE_USDC BASE_USDT BASE_WETH BASE_DAI BASE_CBETH BASE_UNISWAP_V2_FACTORY BASE_SUSHISWAP_V2_FACTORY BASE_BASESWAP_FACTORY BASE_UNISWAP_V3_FACTORY BASE_UNISWAP_V3_QUOTER BASE_CURVE_REGISTRY BASE_BALANCER_VAULT BASE_WETH_PRICE_E8)
